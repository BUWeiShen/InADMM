function[Dtrain,Ctrain,Dval,Cval,Dtest,Ctest] = setupCIFAR10Vgg16(nTrain, nTest, layer)
...
%   layer  = layer in vgg16 (default is pool5)
...
dataDir = [fileparts(which('Meganet.m')) filesep 'data' filesep 'squeezenet' filesep 'CIFAR'];
