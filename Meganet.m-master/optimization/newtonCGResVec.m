classdef newtonCGResVec < optimizer
    ...
    methods
        ...
        function this = newtonCGResVec(varargin)
        ...
        function [xc, xOptLoss, xOptAcc,His, hisCGResVecs] = solve(this,fctn,xc,fval)
            % minimizes fctn starting with xc. (optional) fval is printed
            if not(exist('fval','var')); fval = []; end;
            
            hisCGResVecs = cell(1,1);
