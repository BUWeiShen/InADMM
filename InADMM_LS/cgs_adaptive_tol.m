function [x,flag,relres,iter,resvec] = cgs_adaptive_tol(A,b,adaptive_tol,parameters,tol,maxit,M1,M2,x0,varargin)
...
if (normr <= tolb || stag >= maxstagsteps || moresteps)
    ...
    if adaptive_tol==1
       ...
       bb=parameters.bb;
       dd=afun(x)-b;
       if  ~((2/rhoL)*abs(dd'*(ww-x))+norm(dd)^2 > sigma*norm(AA*x+BB*alpha-bb-gamma/rhoL)^2)
       break
       end
    end
end                                % for ii = 1 : maxit
